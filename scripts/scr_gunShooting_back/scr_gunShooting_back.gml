...
function scr_gunShooting_back(_type_damage, recoil_local, firing_delay_local, bullet_Obj, countBullet_min, countBullet_max, diffCount, speedBullet, diffBullet, boomRandom, particle_Obj, _bulletType)
{
