...
function scr_gunShooting(recoil_local, firing_delay_local, bullet_Obj, countBullet_min, countBullet_max, diffCount, speedBullet, diffBullet, boomRandom, particle_Obj, _type_damage, _soundShot)
{
