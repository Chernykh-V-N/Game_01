...
scr_enemyDamaging		// == скрипт урона по противнику c щитами ==
(
	obj_gunHero.shotgun_mod_hpDamage,		// значение урона оружия
...
//вампиризм от пуль
obj_hero.heroHp += (obj_gunHero.shotgun_mod_hpDamage / 100) * obj_itemContainer.lifesteal_Plus;
